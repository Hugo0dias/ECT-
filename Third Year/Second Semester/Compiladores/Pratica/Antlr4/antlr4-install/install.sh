#!/bin/bash
#
# Miguel Oliveira e Silva (mos@ua.pt), 2020-2024
...
echo "ANTLR4 installation script (Miguel Oliveira e Silva, mos@ua.pt, 2020-2024)."
echo ""
...
echo "Manual installation instructions can be found in file INSTALL.txt (located inside antlr4-bin-v*.zip)."
echo ""
