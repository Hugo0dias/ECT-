...
```
As entidades são: Produto,Encomenda,Fornecedor e TipoDeFornecedor.

Os atributos do Produto são: código,nome,preço,iva e 
número de unidades em armazém(NºStock).
Os atributos da Encomenda são: número da encomenda e a data.
Os atributos do Fornecedor são: nome,NIF,endereço,Fax,condiçãodePagamento.

As relações são Produto-Encomenda, Encomenda-Fornecedor e 
Fornecedor-TipoDeFornecedor.
```
...
```
O grau de relação é binário para todas as relações.

Produto-Encomenda tem cardinalidade de N:M
Encomenda-Fornecedor tem cardinalidade de N:1
Fornecedor-TipoDeFornecedor tem cardinalidade de N:M


Encomenda contém produto, Encomenda fornecida pelo Fornecedor e
Fornecedor tem TipoDeFornecedor são obrigatórias.
```
...
![ex_2_1!](/g2/Images/ex_2_1.png "AnImage or PDF file")
...
![ex_2_2!](/g2/Images/Ex2%20-%20BD.png "AnImage or PDF file")
...
![ex_2_3!](/g2/Images/ex_2_3.png "AnImage or PDF file")
...
![ex_2_4a!](/g2/Images/Ex4-Guiao2-BD.png "AnImage or PDF file")
...
![ex_2_4b!](/g2/Images/Ex4-Guiao2-BD%20(Opcional).png "AnImage or PDF file")